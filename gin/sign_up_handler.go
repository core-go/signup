...
func (h *SignUpHandler) SignUp() gin.HandlerFunc {
...
func (h *SignUpHandler) VerifyUser() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		r := ctx.Request
...
func (h *SignUpHandler) VerifyUserAndSavePassword() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		r := ctx.Request
